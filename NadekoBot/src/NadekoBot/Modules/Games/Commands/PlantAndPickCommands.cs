...
//#endif
            ...
            private static async Task PotentialFlowerGeneration(SocketMessage imsg)
            {
                try
                {
                    ...
                    //await msg.Channel.SendMessageAsync("Test").ConfigureAwait(false);
                    ...
                    /*string flowerGenMsg;
                    flowerGenMsg = $"[DEBUG] No: " + num + " & Chance: " + NadekoBot.BotConfig.CurrencyGenerationChance + " & Cooldown: " + NadekoBot.BotConfig.CurrencyGenerationCooldown;
                    await msg.Channel.SendMessageAsync(flowerGenMsg).ConfigureAwait(false);*/
