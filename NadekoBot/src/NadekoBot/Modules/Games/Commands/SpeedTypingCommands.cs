...
namespace NadekoBot.Modules.Games
{
    public partial class Games
    {
        public class TypingGame
        {
            ...
            private int TypeStartCurrencyRewardTracker = 5;
            ...
            public async Task<bool> Stop()
            {
                ...
                sw.Stop();
                sw.Reset();
                TypeStartCurrencyRewardTracker = NadekoBot.BotConfig.TypeStartCurrencyReward;    //  reset the giving score
            ...
            public async Task Start()
            {
                ...
                try
                {
                    ...
                    TypeStartCurrencyRewardTracker = NadekoBot.BotConfig.TypeStartCurrencyReward;
