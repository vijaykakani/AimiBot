...
namespace Discord.WebSocket
{
    ...
    public abstract class SocketGuildChannel : SocketChannel, IGuildChannel
    {
        ...
        public async Task<RestInviteMetadata> CreateInviteAsync(int? maxAge = 3600, int? maxUses = null, bool isTemporary = true, bool isUnique = false, RequestOptions options = null)
