...
namespace Discord.Rest
{
    public abstract class RestGuildChannel : RestChannel, IGuildChannel, IUpdateable
    {
        ...
        public async Task<RestInviteMetadata> CreateInviteAsync(int? maxAge = 3600, int? maxUses = null, bool isTemporary = true, bool isUnique = true, RequestOptions options = null)
